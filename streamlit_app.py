...
with st.expander("ℹ️ Disclaimer & Privacy Notes"):
    st.markdown("""
    * **Accuracy:** Subtitles are generated by AI (OpenAI Whisper). While highly accurate, the model may occasionally produce errors or hallucinations. Always review the output.
    * **Privacy & Security:** If his application runs locally on your machine. Your files are processed entirely on your own hardware and are **not** uploaded to any external server or cloud storage.
    """)
